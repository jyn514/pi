...
export default function (pi: ExtensionAPI) {
	...
	pi.registerMessageRenderer("status-update", (message, { expanded, outputPad, outputPadY }, theme) => {
		...
		const box = new Box(outputPad, outputPadY, (t) => theme.bg("customMessageBg", t));
